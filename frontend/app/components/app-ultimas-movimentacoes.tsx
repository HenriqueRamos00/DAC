...
export default function UltimasMovimentacoes({ extrato }: UltimasMovimentacoesProps) {
  ...
  return (
    <div className="flex flex-col bg-sidebar border-6 p-2 text-ring">
      <div className="flex items-center border-b border-sidebar-border w-full py-4 gap-4  text-primary">
